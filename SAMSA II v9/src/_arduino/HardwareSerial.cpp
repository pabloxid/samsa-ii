/*
  ...
  Modified 28 September 2010 by Mark Sproul
	Modified 25 November 2011 by Pabloxid
*/
...
/* uso de los puertos seriales:
	0: para diagnóstico y comunicación bluetooth (definido)
	1: para los motores AX12 (no definido)
	2: para la cabeza (definido pero bypasseado el ISR)
	3: sin uso (no definido)
*/

// declaración de buffers

ring_buffer rx_buffer  =  { { 0 }, 0, 0 };      // Serial0
