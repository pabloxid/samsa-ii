...
// NOTA: para habilitar el polling de alto nivel (aka "muestreo") hay que hacer un enable_send_all() y un set_time()
...
class Cabeza {
	...
	public:
		...
		// sensor "inteligente" de distancia
		...
		// clase
		void threshMode ();                                        // habilita el modo con umbrales, desactiva el send_all
		void autoMode ();                                         // habilita el send_all, desactiva los umbrales
		void umbrales ();                                         // preset de umbrales
		void noumbrales ();                                        // resetea los umbrales
		...
		static RingBuffer <volatile byte> fastDistance;       
		////////////////////////////////////////////////////////////
		static volatile byte fastDistanceBuffer [100];        // buffer de distancias rápidas para hacer un scan (atenti al tamaño)
		///////////////////////////////////////////////////////////
...
/*  RESUMEN DEL LENGUAJE USADO PARA EL SENSOR 'INTELIGENTE' DE DISTANCIA
  ...
  * SEND:
      ...
      inst-1 5 --> set time (pause)
			...
			inst-1 7 --> enable / disable send_all
