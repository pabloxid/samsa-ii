...
void motor_setup ()   {                
  ...
  init_filters ();                    // esto no tiene que ver directamente con motores, pero es para filtrar el poll_load
}
...
#define SNS_SAMPLE   50                	  // período de muestreo sensores analógicos
